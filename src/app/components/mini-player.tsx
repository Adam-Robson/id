...
export default function MiniPlayer() {
  ...
  const { songs, current, isPlaying, togglePlay, seek, progress, duration, fmt, prev, next } = audioContext;
      ...
      <div className="mini-player-inner">
        ...
        <div className="mini-player-controls">
          ...
          <div className="mini-player-buttons">
            <button className="mini-player-btn" onClick={prev} aria-label="Previous song">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                <path d="M6 6h2v12H6zm3.5 6 8.5 6V6z"/>
              </svg>
            </button>
            <button className="mini-player-btn mini-player-btn--play" onClick={togglePlay} aria-label={isPlaying ? 'Pause' : 'Play'}>
              {isPlaying ? (
            ...
            <button className="mini-player-btn" onClick={next} aria-label="Next song">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
